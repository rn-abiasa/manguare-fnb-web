    ...
    <>
      <section className="relative bg-[url('/gedung_sate_dither_background.png')] bg-cover bg-center h-screen w-full px-8 md:px-16 lg:px-24 py-10 flex justify-center items-center">
        <div className="flex flex-col justify-center items-center">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-normal text-white leading-tight tracking-tight">
            Bandung
            <br />
            Heritage Flavors
            <br />
          ...
          <p className="text-sm md:text-base font-medium text-white/80 mt-5 max-w-sm leading-relaxed">
